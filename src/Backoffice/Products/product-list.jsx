        ...
        <TableContainer>
          ...
          >
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left" ><a href={`/product/${row._id}`}>#{row.refprod}</a></TableCell>
                    <TableCell
                      component="th"
                      id={labelId}
                      scope="row"
            ...
            <Grid container direction="row" justifyContent="flex-start" alignItems="stretch" spacing={0}> 
                      ...
                      <img src={row.img} alt="Product" style={{ maxWidth: '20%', borderRadius: '5%' }} />
                    ...
                    {/* <TableCell align="right"><img src={row.img} alt="Product" style={{ maxWidth: '20%' }} /></TableCell> */}
                    {/* <TableCell align="right">{row.colors} </TableCell> */}
                    
                    <TableCell align="right">{row.category ? row.category.label : ''}</TableCell>

                    {/* <TableCell align="right">{row.size ? row.size.label : ''}</TableCell> */}

                    {/* <TableCell align="right">
                    <ul>
                       {row.colors.map((color, index) => (
                          <li key={index}>{color.title}</li>
                        ))}
                    </ul>
                    </TableCell> */}
                    ...
                    <TableCell align="right">
                         ...
                         {new Date(row.date).toLocaleString()} {/* Example format */}
                   </TableCell>

                    <TableCell align="right">
                         <Label  color={(row.publish === false && 'error') || 'success'}>{row.publish == true ? 'Published' : 'Draft'}</Label>
                    </TableCell>
            ...
            <Fade in={editModalOpen}>
                <Card sx={style}>
                    <AddProductForm
                        ...
                        user={selectedUser}
                        closeEvent={() => setEditModalOpen(false)}
                        isEdit={isEdit} // Pass isEdit to AddProductForm
